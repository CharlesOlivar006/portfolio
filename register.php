	...
	<?php
		...
		if (isset($_POST["submit"])) {
			...
			if (count($errors) > 0) {
				...
				$sqlInsertInfo = "INSERT INTO account_details_tbl (firstname, lastname, email, password, blk_lot, street, phase_subdivision, barangay, city_municipality, province, country, contact_no) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
